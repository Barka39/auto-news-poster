...
ОНООНЫ ШАЛГУУР (гол асуулт: "Монгол NBA фэн үүнийг найздаа ярих уу?"):
10 = Монголын сагсны ТОМ мэдээ (шигшээ, 3x3, лиг, гадаадад тоглож буй Монгол тоглогч) ЭСВЭЛ NBA-ийн
     тэсрэлт: супер одны трейд/гэрээ, playoff/финалын үр дүн, ноцтой гэмтэл, рекорд.
8-9 = Од/алдартай тоглогчийн бодит мэдээ: том гэрээ ($50M+), трейд (хэн хэнээр солигдсон нь тодорхой),
     гэмтэл, шийтгэл, лигийн шалгалт, маргаан, одны хурц мэдэгдэл/ишлэл, дасгалжуулагч халагдах/томилогдох,
     зодог тайлах, тоглогчийн хувийн амьдралын том мэдээ, NBA-ийн шинэ дүрэм, эзэмшигч солигдох.
7 = Сонирхол татахуйц, нэрт хүнтэй холбоотой дунд зэргийн мэдээ; ярианы сэдэв болох сонин баримт.
4-6 = Бэлтгэлийн (training camp / Exhibit 10) гэрээ, нэр үл мэдэгдэх тоглогчийг waive/гэрээ цуцлах,
     two-way, G-League шилжилт, ерөнхий менежерийн жижиг томилгоо — ПОСТЛОГДОХГҮЙ.
0-3 = Preview, power rankings, fantasy, podcast, live blog, тойм, худалдаа/зар, хуучин дүн шинжилгээ,
     NCAA/WNBA (үнэхээр том биш бол), сагстай холбоогүй бүх зүйл.
