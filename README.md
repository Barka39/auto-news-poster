...
### Контент хуудсууд (2026-09-21): Сүнсний код, Үдшийн шивнээ
Мэдээ биш, ҮҮСГЭСЭН контент (`modules/pages_content.py`, `pages_run.py`), ижил 10 минутын run дотор
слотын цаг болоход постолно; төлөв `pages_state.json`.
- **Сүнсний код** (`_SUNS`): 08:00 өдрийн зурхай (12 орд, гараг, сарны үе шат — бодит тооцоо), 13:00 сүнслэг
  сургаал (15 сэдвийн эргэлт: Буддын сургаал, ёс заншил, зүүд, тарот, чакра, angel numbers...), 21:00 өдрийн
  тоо (numerology).
- **Үдшийн шивнээ** (`_UDESH`): 21:30 үргэлжилсэн өгүүллэг (3-5 хэсэг, cliffhanger, дараагийн өдөр үргэлжилнэ),
  12:30 уншигчийн "нууц захидал". Хатуу хязгаар (prompt-д): ил задгай бэлгийн дүрслэлгүй, насанд хүрээгүй
  дүргүй, хүчирхийлэлгүй — Facebook-ийн community standards.
- Secret: `FB_PAGE_ID_SUNS/FB_ACCESS_TOKEN_SUNS`, `FB_PAGE_ID_UDESH/FB_ACCESS_TOKEN_UDESH` —
  `FB-TOKEN-SUULGAH.bat` нэг удаад гурван хуудсыг бүгдийг тавина (нэрээр нь таньдаг).
- Шалгах: Draft Check → mode `pages` (бүх слот нэг дор ноорог).
